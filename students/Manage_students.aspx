<%@ Page Title="" Language="C#" MasterPageFile="~/m.master" AutoEventWireup="true" ValidateRequest="false"  CodeFile="Manage_students.aspx.cs" Inherits="students_List" %>
...
<strong> 姓名:</strong><asp:TextBox ID="txt_stname" runat="server" width="150"></asp:TextBox>
    ...
    <tr>
        ...
        <Columns>       
            ...
            <ItemTemplate>
<input id="btnShow" type="button" value="详情"  onclick="location.href = 'View_students.aspx?id=<%#Eval("sno") %>'; "  class="btn btn-info-outline" />
<input id="btnEdit" type="button" value="修改"  onclick="location.href = 'Modify_students.aspx?id=<%#Eval("sno") %>'; "  class="btn btn-info-outline" />
