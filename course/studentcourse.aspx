<%@ Page Title="" Language="C#" MasterPageFile="~/m.master" AutoEventWireup="true" CodeFile="studentcourse.aspx.cs" Inherits="course_studentcourse" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        ...
        <Columns>       
            ...
            <ItemTemplate>
<%--<input id="btnShow" type="button" value="课程详情"  onclick="location.href = 'View_course.aspx?id=<%#Eval("coid") %>'; "  class="btn btn-info-outline" />--%>
<asp:LinkButton ID="btnck" CommandName="ck" CommandArgument='<%#Eval("coid") %>' runat="server" class="btn btn-info-outline">取消选课</asp:LinkButton>
